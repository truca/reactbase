...
//var socket = io("zeroq.ml:8080/", connectionOptions);
var socket = io.connect("ws://zeroq.ml:8080/");

var App = React.createClass({
	displayName: 'App',
	getInitialState: function getInitialState() {
		return {
			queues: [{ name: 'Fila Cheques', number: 16, q_queue: 10 }, { name: 'Fila Despidos', number: 28, q_queue: 5 }]
		};
	},
	componentDidMount: function componentDidMount() {
		//setTimeout(this.changeNumber, 5000);
	...
	changeNumber: function changeNumber() {
		var index = Math.floor(Math.random() * this.state.queues.length);
		var attributes = ["number", "q_queue"];
		var attribute_index = Math.floor(Math.random() * attributes.length);

		var queues = this.state.queues;

		console.log(index, attributes[attribute_index], queues[index][attributes[attribute_index]]);
		queues[index][attributes[attribute_index]] = queues[index][attributes[attribute_index]] + 1;
		console.log(index, attributes[attribute_index], queues[index][attributes[attribute_index]]);

		this.setState({ queues: queues });
		setTimeout(this.changeNumber, Math.floor(Math.random() * 2 * 60 * 1000 + 10 * 1000));
	},
	render: function render() {
		return React.createElement(
			...
			React.createElement(Queues, { queues: this.state.queues })
		);
	}
});
...
},{"./Nav":2,"./Queues":4,"react":172,"react-dom":7,"socket.io-client":173}],2:[function(require,module,exports){
'use strict';
...
},{"./Queue":3,"react":172,"react-dom":7}],3:[function(require,module,exports){
'use strict';
...
var Queue = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: this.props.futureClass + " row" },
			React.createElement(
				'div',
			...
			React.createElement(
				'div',
				{ className: 'col-xs-3 text-centered' },
				this.props.queue.number
			),
			React.createElement(
				'div',
				{ className: 'col-xs-3 text-centered' },
				this.props.queue.q_queue
			)
		);
	}
});
...
},{"react":172,"react-dom":7}],4:[function(require,module,exports){
'use strict';
...
var Header = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col-xs-6 text-left no-padding' },
				' '
			),
			React.createElement(
				'div',
...
var Queues = React.createClass({
	displayName: 'Queues',
	render: function render() {
		return React.createElement(
			'div',
			{ className: 'container queues' },
			React.createElement(Header, null),
			this.props.queues.map(function (queue, i) {
				return React.createElement(Queue, { key: i, queue: queue, futureClass: i % 2 == 0 ? 'pair-line' : 'odd-line' });
			})
		);
	}
});
...
},{"./Queue":3,"react":172,"react-dom":7}],5:[function(require,module,exports){
...
},{"./ReactChildren":36,"./ReactClass":37,"./ReactComponent":38,"./ReactDOMFactories":51,"./ReactElement":68,"./ReactElementValidator":69,"./ReactPropTypes":91,"./ReactVersion":97,"./onlyChild":137,"_process":6,"fbjs/lib/warning":170,"object-assign":171}],34:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactComponent":38,"./ReactElement":68,"./ReactNoopUpdateQueue":86,"./ReactPropTypeLocationNames":89,"./ReactPropTypeLocations":90,"_process":6,"fbjs/lib/emptyObject":153,"fbjs/lib/invariant":160,"fbjs/lib/keyMirror":163,"fbjs/lib/keyOf":164,"fbjs/lib/warning":170,"object-assign":171}],38:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMPropertyOperations":18,"./DisabledInputUtils":21,"./LinkedValueUtils":31,"./ReactDOMComponentTree":47,"./ReactUpdates":96,"_process":6,"fbjs/lib/invariant":160,"fbjs/lib/warning":170,"object-assign":171}],55:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildren":36,"./ReactDOMComponentTree":47,"./ReactDOMSelect":57,"_process":6,"fbjs/lib/warning":170,"object-assign":171}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./DisabledInputUtils":21,"./LinkedValueUtils":31,"./ReactDOMComponentTree":47,"./ReactUpdates":96,"_process":6,"fbjs/lib/warning":170,"object-assign":171}],58:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":14,"./DOMLazyTree":15,"./ReactDOMComponentTree":47,"./ReactPerf":88,"./escapeTextContentForBrowser":121,"./validateDOMNesting":144,"_process":6,"fbjs/lib/invariant":160,"object-assign":171}],60:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMPropertyOperations":18,"./DisabledInputUtils":21,"./LinkedValueUtils":31,"./ReactDOMComponentTree":47,"./ReactUpdates":96,"_process":6,"fbjs/lib/invariant":160,"fbjs/lib/warning":170,"object-assign":171}],61:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":42,"./canDefineProperty":118,"_process":6,"fbjs/lib/warning":170,"object-assign":171}],69:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
...
},{"_process":6,"fbjs/lib/invariant":160,"object-assign":171}],85:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":12,"./PooledClass":32,"./ReactFeatureFlags":74,"./ReactPerf":88,"./ReactReconciler":93,"./Transaction":114,"_process":6,"fbjs/lib/invariant":160,"object-assign":171}],97:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCompositeComponent":41,"./ReactEmptyComponent":70,"./ReactNativeComponent":84,"_process":6,"fbjs/lib/invariant":160,"fbjs/lib/warning":170,"object-assign":171}],135:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./manager":174,"./socket":176,"./url":177,"debug":181,"socket.io-parser":214}],174:[function(require,module,exports){
...
},{"./on":175,"./socket":176,"backo2":178,"component-bind":179,"component-emitter":180,"debug":181,"engine.io-client":184,"indexof":211,"socket.io-parser":214}],175:[function(require,module,exports){
...
},{"./on":175,"component-bind":179,"component-emitter":180,"debug":181,"has-binary":209,"socket.io-parser":214,"to-array":219}],177:[function(require,module,exports){
(function (global){
...
},{"debug":181,"parseuri":212}],178:[function(require,module,exports){
...
},{"./socket":186,"engine.io-parser":196}],186:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"./transport":187,"./transports":188,"component-emitter":194,"debug":181,"engine.io-parser":196,"indexof":211,"parsejson":206,"parseqs":207,"parseuri":212}],187:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":194,"engine.io-parser":196}],188:[function(require,module,exports){
(function (global){
/**
 * Module dependencies
 */
...
},{"./polling-jsonp":189,"./polling-xhr":190,"./websocket":192,"xmlhttprequest-ssl":193}],189:[function(require,module,exports){
(function (global){
...
},{"./polling":191,"component-inherit":195}],190:[function(require,module,exports){
(function (global){
/**
 * Module requirements.
 */
...
},{"./polling":191,"component-emitter":194,"component-inherit":195,"debug":181,"xmlhttprequest-ssl":193}],191:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":187,"component-inherit":195,"debug":181,"engine.io-parser":196,"parseqs":207,"xmlhttprequest-ssl":193,"yeast":208}],192:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":187,"component-inherit":195,"debug":181,"engine.io-parser":196,"parseqs":207,"ws":5,"yeast":208}],193:[function(require,module,exports){
...
},{"has-cors":205}],194:[function(require,module,exports){
...
},{"./keys":197,"after":198,"arraybuffer.slice":199,"base64-arraybuffer":200,"blob":201,"has-binary":202,"utf8":204}],197:[function(require,module,exports){
...
},{"isarray":210}],210:[function(require,module,exports){
...
},{"./binary":213,"./is-buffer":215,"component-emitter":216,"debug":181,"isarray":217,"json3":218}],215:[function(require,module,exports){
(function (global){
...
},{"dup":194}],217:[function(require,module,exports){
arguments[4][203][0].apply(exports,arguments)
},{"dup":203}],218:[function(require,module,exports){
(function (global){
